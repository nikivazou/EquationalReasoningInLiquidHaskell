...
{-@ specComp' :: e:Expr -> c:Code 
                 -> { comp' e c = comp e ++ c } @-}
specComp' :: Expr -> Code -> ()
specComp' _ _ = undefined   
...
{-@ comp' :: e:Expr -> c:Code 
          -> {o:Code | comp' e c = comp e ++ c  && addCount c + exprAdds e == addCount o} @-}
comp' :: Expr -> Code -> Code 
comp' (Val n) c 
  =   comp (Val n) ++ c ? specComp' (Val n) c
  ==. [PUSH n] ++ c 
  ==. []++(PUSH n:c)
  ==. PUSH n:c
  ^^^ Defined 
...
-- LH TODO: these should get autogenerated by reflection of 
-- comp' & inlining of the Def operations 
{-@ reflect comp' @-}

{-@ definedCompVal :: n:Int -> c:Code -> s:Stack 
                   -> { comp' (Val n) c == PUSH n:c } @-}
definedCompVal :: Int -> Code -> Stack -> Proof
definedCompVal = undefined 

{-@ definedCompAdd :: x:Expr -> y:Expr -> c:Code -> s:Stack 
                   -> { comp' (Add x y) c == comp' x (comp' y (ADD:c)) } @-}
definedCompAdd :: Expr -> Expr -> Code -> Stack -> Proof
definedCompAdd = undefined 
